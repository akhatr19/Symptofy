...
struct FoodVSSymptomChartView: View {

    @State private var data = [(medName: String, data: [FoodVSSymptomChartDisplayData])]()
    @State var fromDate: Date
    @State var toDate: Date
    @ObservedObject var vm = FoodVSSymptomChartViewModel()
    ...
    var body: some View {
        ...
        .navigationTitle("Food vs Symptoms Chart")
        .onAppear {
...
//struct FoodVSSymptomView_Previews: PreviewProvider {
//    static var previews: some View {
//        FoodVSSymptomChartView()
//    }
//}
